...
$query1 = "SELECT CONCAT(d.firstName, ' ', d.lastName, ' Donates ', do.amount, ' Dollars to ',NVL(CONCAT(o.firstName ,' ' ,o.lastName),camp.name), ' at ', do.datte) AS history
FROM donor AS d
JOIN donations AS do ON d.donorID = do.donorID
LEFT JOIN organization AS o ON do.organizationID = o.organizationID
LEFT JOIN campaigns AS camp ON do.c_ID = camp.c_ID
where d.email = '$email' order by do.datte ASC";
...
<div class="d-flex justify-content-center mx-3 my-5">
    <div class="row col-11 lowerpart">
        <div class="mt-4 mx-3 d-flex gap-3">
            ...
            <h3 class="text-white fs-4">History Details</h3><br>
        </div>
