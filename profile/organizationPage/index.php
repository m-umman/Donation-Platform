<?php 
 ...
 $query1 = "Select * from organization where email = '$email'";
 ...
 $query2 = "Select * from organization_phone where organizationID = $id";
 ...
 $sphone = $row2['phone'];
  ...
  $query_total_donations = "Select SUM(amount) As amount from donations where organizationID = $id";
  ...
  <div class="row gx-0 px-0 w-100">
    ...
    <div class="col-lg-10 col-md-9 col-12 side2 d-flex flex-column min-vh-100">
      <div class="upper-part d-flex justify-content-between px-4 py-3">
        ...
        echo "<a href='' class='fs-3 fw-bold text-warning text-decoration-none'>Total Donated Amount : </span>{$row_amount['amount']}</a>";
        ?>
      </div>
      ...
      <div class="d-flex justify-content-center w-100">
        <div class="row col-11 lowerpart w-100">
          <div class="d-flex gap-3 mt-3">
            ...
            <h3 class="text-white fs-5">Organization Details</h3>
          </div>
          ...
          <div class='row'>
           ...
           <div class='row'>
                     <div class='col-sm-6 col-12'>
                       <h6 class='mb-1 fs-6' style='color : white;'>Province</h6><br>
                       <p class='w-100 py-3 px-2 rounded-2 fw-bold' style='background-color:white ; color: black; '> $province</p>
                     </div>
                     <div class='col-sm-6 col-12'>
                       <h6 class='mb-1 fs-6' style='color : white;'>City</h6><br>
                       <p class='w-100 py-3 px-2 rounded-2 fw-bold' style='background-color:white ; color: black; '> $city</p>
                     </div>
          </div>
        ...
        <div class="row gx-0 px-0 d-flex align-items-center justify-content-center" style="position: relative;">
          ...
          <form class="col-sm-3 col-8 text-center" style="background-color: azure; height: 300px; border-radius: 10px; padding: 20px;" action="update.php" method="post">
            ...
            <select name="data" id="data" class="py-3 px-2 rounded-2 fw-bold text-black-50 w-100" required>
              ...
              <option value="7">Province</option>
