...
<body>
    ...
    <section class="container-fluid position-relative d-flex align-items-center justify-content-center gx-0 px-0">
        <div class="row w-100 gx-0">
          <img src="main.jpg" style="object-fit: cover; height: 300px; filter: grayscale(50%) brightness(50%); " class="img-fluid"  >
        </div>
        
        <div class="page_name position-absolute  ">
          <h2 class="fw-bold text-white fs-1">Give Your Review</h2>
          <p class="fw-bold text-white text-center">Home <span style="color: aquamarine;">></span> Review</p>
        </div>
      </section>
      ...
      <section class="container-fluid mt-5 " style="min-height: 1000px; ">
        <div class="row  d-flex align-items-center justify-content-center mt-5">
            <div class="col-sm-5 col-12  d-flex align-items-center justify-content-center mt-5" style=" background-color: #e2ded5;">
                <form class="col-sm-8 col-12 mt-3" style="min-height:600px ;" action="dataSending.php" method="post">   
                   <div class="row mt-3">
                     
                     <div class="row mt-3">
                        <label for="review" class="mb-3 fs-6">Enter Yor Review*</label><br>
                        <textarea name="review" id="review" class="w-100 py-3 px-2 rounded-2 fw-bold" required ></textarea>
                           ...
                           <div class="row mt-3">
                                ...
                                <select name="ngos" id="ngos" class="py-3 px-2 rounded-2 fw-bold text-black-50 w-100" required>
                                    <option value="">Select Ngos Name</option>
                                    <?php    
                    ...
                    <button class="row mt-5 p-3 fw-bold w-100 rounded-3 d-flex align-items-center justify-content-center donate_button" type="submit" style="color: white; background-color: #FC8500;">Send NOW</button>        
                      <div class="row mt-3">             
                    <?php 
